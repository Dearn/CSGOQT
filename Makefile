#############################################################################
# Makefile for building: CSGOQT
# Generated by qmake (3.0) (Qt 5.0.2) on: niedz. kwi 20 23:11:36 2014
# Project:  CSGOQT.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -o Makefile CSGOQT.pro
#############################################################################
...
INCPATH       = -I/usr/share/qt5/mkspecs/linux-g++-64 -I. -I-I -I/usr/include/jsoncpp -I. -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I.
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
LIBS          = $(SUBLIBS) -L/usr/X11R6/lib64 -lcurl -l:libjsoncpp.so -lQt5Widgets -L/usr/lib/x86_64-linux-gnu -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
Makefile: CSGOQT.pro /usr/share/qt5/mkspecs/linux-g++-64/qmake.conf /usr/share/qt5/mkspecs/features/spec_pre.prf \
		/usr/share/qt5/mkspecs/common/shell-unix.conf \
		/usr/share/qt5/mkspecs/common/unix.conf \
		/usr/share/qt5/mkspecs/common/linux.conf \
		/usr/share/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d .tmp/CSGOQT1.0.0 || mkdir -p .tmp/CSGOQT1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/CSGOQT1.0.0/ && $(COPY_FILE) --parents json.h qt.h .tmp/CSGOQT1.0.0/ && $(COPY_FILE) --parents json.cpp main.cpp qt.cpp .tmp/CSGOQT1.0.0/ && (cd `dirname .tmp/CSGOQT1.0.0` && $(TAR) CSGOQT1.0.0.tar CSGOQT1.0.0 && $(COMPRESS) CSGOQT1.0.0.tar) && $(MOVE) `dirname .tmp/CSGOQT1.0.0`/CSGOQT1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/CSGOQT1.0.0
...
compiler_moc_header_clean:
	-$(DEL_FILE) moc_qt.cpp
moc_qt.cpp: /usr/include/qt5/QtCore/QVariant \
		...
		qt.h
	/usr/lib/x86_64-linux-gnu/qt5/bin/moc $(DEFINES) $(INCPATH) qt.h -o moc_qt.cpp
